 ...
 * required field. We feed exact validation errors back to the model and ask
 * it to correct them, up to `maxRetries` times, before giving up with a clear
 * error. Output is never silently rewritten here: generation rules belong in
 * prompts and correctness rules belong in schemas.
 */
