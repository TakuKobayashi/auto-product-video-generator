...
export function analyzeCommand(): Command {
  return new Command('analyze')
    ...
    .option('--source-context <path>', 'source context JSON output (default: <workDir>/source-context.json)')
    .option('--project-summary <path>', 'project summary JSON output (default: <workDir>/project-summary.json)')
