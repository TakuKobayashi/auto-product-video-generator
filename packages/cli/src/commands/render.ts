...
export function renderCommand(): Command {
  return new Command('render')
    ...
    .option('--recordings-dir <path>', 'recorded MP4 input directory (default: <workDir>/recordings)')
    .option('--screenshots-dir <path>', 'screenshot artifact input directory (default: <workDir>/screenshots)')
    ...
    .option('--artifacts-dir <path>', 'intermediate artifact output directory (default: <outputDir>/artifacts)')
